...
//		list.addListener((ListChangeListener<? super TreeItem<T>>) childrenListener);
		 ...
		 */
		@Override	public ObservableList<TreeItem<T>> getChildren() {			return filteredList;		}		
		/**
		 * Returns the list of children that is backing the filtered list.
		 * @return underlying list of children
		 */
		public ObservableList<TreeItem<T>> getInternalChildren() {		return super.getChildren();		}
		 ...
		 */
		@Override	public boolean isLeaf() {			return getChildren().isEmpty();		}
		/**
		 * @return the predicate property
		 */
		public final ObjectProperty<TreeItemPredicate<T>> predicateProperty() {	        return predicate;	    }
		/**
		 * @return the predicate
		 */
	    public final TreeItemPredicate<T> getPredicate() {	        return predicate.get();	    }
	    /**
	     * Set the predicate
	     * @param predicate the predicate
	     */
	    public final void setPredicate(TreeItemPredicate<T> p) {	    	predicate.set(p);	    }
	}
