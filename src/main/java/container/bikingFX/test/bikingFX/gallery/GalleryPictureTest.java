 ...
 */
package container.bikingFX.test.bikingFX.gallery;
...
public class GalleryPictureTest {
	...
	final JsonReader jsonReader = Json.createReader(GalleryPictureTest.class.getResourceAsStream("../resources/gallery/singleGalleryPicture.json"));
	final GalleryPicture galleryPicture = new GalleryPicture(jsonReader.readObject());
	Assert.assertEquals(LocalDate.of(2009, 4, 9), galleryPicture.getTakenOn());
