//http://johnthecodingarchitect.blogspot.com/2013/11/scaling-vs-zooming-in-javafx.html
...
public class ScalingDemo extends Application{
    ...
    private class ZoomingPane extends Pane {
        ...
        public final Double getZoomFactor() {        return zoomFactor.get();   }
        public final void setZoomFactor(Double zoomFactor) {     this.zoomFactor.set(zoomFactor);   }
        public final DoubleProperty zoomFactorProperty() {    return zoomFactor;       }
    }
