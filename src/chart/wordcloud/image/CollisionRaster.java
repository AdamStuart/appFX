...
public class CollisionRaster {
    ...
    public void setRGB(int x, int y, int rgb) 	{        data[x][y] = rgb;    }
    ...
    public boolean isTransparent(int x, int y) {    return (data[x][y] & 0xFF000000) == 0x00000000;    }
